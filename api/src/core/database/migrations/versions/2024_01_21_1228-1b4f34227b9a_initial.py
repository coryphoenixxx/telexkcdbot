...
def upgrade() -> None:
    ...
    op.create_index('uq_version_per_translation', 'translation_images', ['version', 'translation_id'], unique=True, postgresql_where=sa.text('translation_id IS NOT NULL'))
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('uq_version_per_translation', table_name='translation_images', postgresql_where=sa.text('translation_id IS NOT NULL'))
