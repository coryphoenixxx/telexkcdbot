...
from api.application.images.dtos import ImageObj
from api.application.images.exceptions import (
    RequestFileIsEmptyError,
    UnsupportedImageFormatError,
    UploadExceedLimitError,
)
from api.application.images.types import ImageFormat
...
class UploadImageReader:
    ...
    def __init__(self, tmp_dir: Path, upload_max_size: int):
