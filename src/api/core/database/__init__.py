...
from api.application.comics.repo import ComicRepo
from api.application.images.repo import TranslationImageRepo
from api.application.translations.repo import TranslationRepo
